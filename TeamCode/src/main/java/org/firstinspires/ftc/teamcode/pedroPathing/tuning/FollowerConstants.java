...
public class FollowerConstants {
    ...
    private static double xMovement = 62.90851343983032;
    private static double yMovement = 38.083102226328386;
    ...
    public static double mass = 9.85;

    // Centripetal force to power scaling
    public static double centripetalScaling = 0.00000005;


    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double forwardZeroPowerAcceleration = -35.12101396922632;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -66.0468166344461;
