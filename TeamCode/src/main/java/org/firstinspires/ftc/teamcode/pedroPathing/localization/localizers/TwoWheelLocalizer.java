...
public class TwoWheelLocalizer extends Localizer { // todo: make two wheel odo work
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.0019827854533540287;
    public static double STRAFE_TICKS_TO_INCHES = -0.0019827854533540287;
    ...
    public TwoWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "par1"));
