...
//    static {
//        System.loadLibrary("Adafruit_BNO055");
//    }


    //private native int doThing();
...
//    private List<Action> runningActions = new ArrayList<>();
    ...
    public void runOpMode() {
        initIMU();
        externalIMU.startAccelerationIntegration(new Position(DistanceUnit.INCH, 0, 0, 0, System.nanoTime()), new Velocity(DistanceUnit.INCH,0,0,0,System.nanoTime()), 100);
...
//        dash.sendTelemetryPacket(packet);
    ...
    public void initIMU() {
        ...
        p.accelRange = BNO055IMU.AccelRange.G8;
