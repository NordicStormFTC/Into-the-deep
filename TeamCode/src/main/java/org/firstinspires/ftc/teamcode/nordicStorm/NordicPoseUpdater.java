...
public class NordicPoseUpdater extends PoseUpdater {
     ...
     */
    public NordicPoseUpdater(HardwareMap hardwareMap, @NonNull Localizer localizer) {
        super(hardwareMap);
...
//        }
     ...
     * @param hardwareMap the HardwareMap
     */
    public NordicPoseUpdater(HardwareMap hardwareMap) {
