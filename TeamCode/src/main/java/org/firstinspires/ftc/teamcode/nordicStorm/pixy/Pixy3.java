...
@I2cDeviceType
@DeviceProperties(name = "Pixy3 Smart Camera", description = "Pixy3 Smart Camera", xmlTag = "MCP9808")
public class Pixy3 extends I2cDeviceSynchDeviceWithParameters<I2cDeviceSynch, Pixy3.PixyCam2Params> {
    ...
    public void requestSync() {
        this.deviceClient.write(new byte[]{(byte) 0xae, (byte) 0xc1, (byte) 22, (byte) 2, (byte) 1, (byte) 0}); // reads 43433
    ...
    public void readSync(@NonNull Telemetry telemetry) {
        ...
        telemetry.addData("one", rawBytes[0]);
        telemetry.addData("two", rawBytes[1]);
        telemetry.addData("combined", combineBytes(rawBytes[0], rawBytes[1]));
